...
@section('admin.content')
    <div class="row">
        <div class="col-md-6"><div class="Overview Panel"><div class="Content overview-content"><div class="overview-title"><p class="counter">{{ $active->view->count or 0 }}</p><span>浏览量</span></div><div class="overview-icon"><i class="fa fa-eye"></i></div></div></div></div>
